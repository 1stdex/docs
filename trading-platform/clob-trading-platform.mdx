---
title: "1st Trading Platform"
description: "1st is powered by a native, onchain Central Limit Order Book (CLOB)."
icon: "chart-line"
...
**Trading on 1st feels like Web2 — but it's powered by bleeding-edge crypto.**
...
1st uses a fully on-chain **CLOB** to power MirrorToken trading. That means:
