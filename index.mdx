...
<Columns cols={2}>
  <Card title="Explore the Protocol" icon="network-wired" href="/overview/what-is-1st" cta="Understand the 1st architecture">
    How MirrorTokens, Vaults, and Delivery Commitments work together.
  </Card>
  <Card title="How MirrorTokens work" icon="swap" href="/core/mirrortokens" cta="Explore MirrorToken mechanics">
    Learn how to find, trade, and redeem MirrorTokens for real token delivery.
  </Card>
  <Card title="Token Delivery Commitment (TDC)" icon="signature" href="/core/token-delivery-commitment" cta="Read how TDCs work">
    The legal backbone of 1st. Simple, enforceable, and VC-friendly.
  </Card>
  <Card title="CLOB Trading Platform" icon="arrow-right-arrow-left" href="/trading-platform/clob-trading-platform" cta="Learn how the 1st CLOB works">
