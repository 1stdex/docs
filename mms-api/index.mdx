...
> **Architecture:** each _pair_ has **two order books**, one per direction. Orders are denominated in **units** (multiples of `unitSize`) at discrete **ticks**. See [Core concepts](/mms-api/concepts/core).
...
Get started in **[Quickstart](/mms-api/guides/quickstart)**.
