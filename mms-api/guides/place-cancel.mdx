...
- `MakeOrderParams(id:uint192, tick:int24, quoteAmount:uint256, provider:address, referrer:address)`
- `LimitOrderParams(id:uint192, tick:int24, quoteAmount:uint256, makeProvider:address, makeReferrer:address, takeProvider:address, takeReferrer:address)`
- `TakeOrderParams(id:uint192, limitPrice:uint256, quoteAmount:uint256, maxBaseAmount:uint256, provider:address, referrer:address)`
- `SpendOrderParams(id:uint192, limitPrice:uint256, baseAmount:uint256, minQuoteAmount:uint256, provider:address, referrer:address)`
- `ClaimOrderParams(id:uint256)`
- `CancelOrderParams(id:uint256, leftQuoteAmount:uint256)`
