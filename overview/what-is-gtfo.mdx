...
icon: "house"
description: "GTFO is a decentralized protocol that unlocks liquidity for locked token allocations."
---
...
- Traders can’t get exposure to pre-TGE deals
...
> GTFO turns this problem into an opportunity — by reimagining how vesting rights are represented and exchanged.

## 🧬 The Solution: MirrorTokens

GTFO introduces **MirrorTokens** — ERC-20 tokens that represent enforceable rights to future token delivery.

Each MirrorToken:

- Is backed by a **legally binding Token Delivery Commitment (TDC)**
- Is **physically settled** — tokens must be delivered on-chain
...
The foundation of GTFO is the **Token Delivery Commitment (TDC)** — a signed, one-sided agreement where the issuer commits to deliver tokens to a smart contract vault on a fixed schedule.
...
5. **Tokens are delivered on-chain**\
...
Whether you're a fund, a contributor, or a trader — GTFO makes locked allocations **liquid, legal, and usable.**
...
**GTFO is the infrastructure layer for trading locked token allocations.**
