---
title: "GTFO Protocol Overview"
description: "GTFO is a decentralized protocol for trading locked token allocations via enforceable tokenized forward contracts"
icon: "bookmark"
---
...
GTFO is composed of four main components:
...
Here’s how the GTFO Protocol works from start to settlement:
...
The legal layer is what makes GTFO different from other “wrapped vesting” ideas.
...
This qualifies GTFO under **CFTC regulatory precedent**, not SEC jurisdiction.
...
There are no GTFO protocol fees. Traders may incur DEX fees and gas costs.

→ [Explore economic model](./economic-model)

## 🧠 Minimal Governance

GTFO is built to run without discretionary intervention.
...
GTFO unlocks a wide range of new behaviors:
...
GTFO is a protocol for turning locked token allocations into real, liquid, enforceable financial instruments.
