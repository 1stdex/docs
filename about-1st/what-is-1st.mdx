...
Mirror tokens turn locked, private-market token allocations into on-chain assets that can be traded instantly on a DEX with deep liquidity and fractional access.
...
A mirror token is an on-chain representation of a locked token allocation, most often created from early-stage investment agreements such as SAFTs or SAFEs.
